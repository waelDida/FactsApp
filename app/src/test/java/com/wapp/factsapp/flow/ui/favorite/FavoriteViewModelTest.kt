...
class FavoriteViewModelTest{
    ...
    private val fact1 = Fact("1",isLiked = true)
    private val fact2 = Fact("2",isLiked = true)
    private val fact3 = Fact("3",isLiked = false)
    ...
    fun createViewModel(){
        ...
        favoriteViewModel = FavoriteViewModel(fakeFactRepository)
    }

    @Test
    fun `get only liked facts`(){
        val x = favoriteViewModel.likedFacts.getOrAwaitValue() as Resource.Success
